...
class IPCameraDeviceController(DeviceController):
    ...
    def get_camera_stream_configuration(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_snapshot(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def get_snapshot_list(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_camera_move(self, pairedDeviceId, keyId):
        '''
        child class should override this function to implement their body
        '''
        pass
