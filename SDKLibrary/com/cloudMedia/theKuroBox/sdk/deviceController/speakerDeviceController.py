...
from com.cloudMedia.theKuroBox.sdk.service.ttsService import TTSService
...
class SpeakerDeviceController(DeviceController):
    ...
    def get_status(self, pairedDeviceId, isLocal=False):
        '''
        child class should override this function to implement their body
        '''
        pass

    def check_start(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_init(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_start(self, pairedDeviceId, url, name="", album="", artist="", albumArt="", urlDetails="", urlFormat="", memorize=True):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_pause(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_resume(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_stop(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def get_mute_status(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_mute_status(self, pairedDeviceId, mute):
        '''
        child class should override this function to implement their body
        '''
        pass

    def get_volume(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_volume(self, pairedDeviceId, volume):
        '''
        child class should override this function to implement their body
        '''
        pass

    def get_now_playing_status(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass
