...
class ThermostatDeviceController(DeviceController):
    '''
    Thermostat Device Controller Base Class
    '''
    ...
    def set_mode(self, pairedDeviceId, deviceDTO, modeId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_fan_mode(self, pairedDeviceId, deviceDTO, fanMode):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_setpoint(self, pairedDeviceId, deviceDTO, modeId, targetTermperature):
        '''
        child class should override this function to implement their body
        '''
        pass
