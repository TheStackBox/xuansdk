...
class DoorLockDeviceController(DeviceController):
    '''
    ...
    def set_lock(self, pairedDeviceId, deviceDTO):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_unlock(self, pairedDeviceId, deviceDTO):
        '''
        child class should override this function to implement their body
        '''
        pass

    def get_lock_status(self, pairedDeviceId, deviceDTO):
        '''
        child class should override this function to implement their body
        '''
        pass
    ...
    def get_battery_level(self, pairedDeviceId, deviceDTO):
        '''
        child class should override this function to implement their body
        '''
        pass
