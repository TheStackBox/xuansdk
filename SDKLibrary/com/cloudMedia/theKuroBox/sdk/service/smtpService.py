...
class SMTPService():
    ...
    @staticmethod
    def send_smtp_mail(recipient, cc=[], subject="", text="", attachment=[], language=AppInfo.DEFAULT_API_LANGUAGE):
        '''
        ...
        attachment:List :- attachment list to the email address. Example: [{"path": "/tmp/attachment1.tar"}, {"path": "/tmp/attachment2.tar"}]
