...
class FoscamF19821wService(object):
    ...
    @staticmethod
    def camera_zoom_out(isSecured, host, port, username, password, language=AppInfo.DEFAULT_API_LANGUAGE):
    ...
    @staticmethod
    def camera_zoom_stop(isSecured, host, port, username, password, language=AppInfo.DEFAULT_API_LANGUAGE):
