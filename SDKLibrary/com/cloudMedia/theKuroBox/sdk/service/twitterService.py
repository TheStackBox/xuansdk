...
class TwitterService():
    ...
    @staticmethod
    def get_twitter_rate_limit(resources, language=AppInfo.DEFAULT_API_LANGUAGE):
        '''
        get twitter rate limit list base on given resources
        return:Dictionary :eg- {"response":{"resources":{"friends": {
                                "/friends/following/ids":{"remaining": 15, "limit": 15, "reset": 1412569096},
                                "/friends/list": {"remaining": 15, "limit": 15, "reset": 1412569096},
                                "/friends/ids": {"remaining": 15, "limit": 15, "reset": 1412569096},
                                "/friends/following/list": {"remaining": 15, "limit": 15, "reset": 1412569096}}}}}
        '''
        pass
