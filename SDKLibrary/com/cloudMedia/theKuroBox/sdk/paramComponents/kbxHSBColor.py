...
from com.cloudMedia.theKuroBox.sdk.paramTypes.kbxHSBColor import KBXHSBColor as KBXHSBColorSDK
from com.cloudMedia.theKuroBox.sdk.util.logger import Logger
from com.cloudMedia.theKuroBox.sdk.util.util import Util

class KBXHSBColor(KBXHSBColorSDK, KBXParamComponent):

    COM_NAME = "kbxHSBColor"
