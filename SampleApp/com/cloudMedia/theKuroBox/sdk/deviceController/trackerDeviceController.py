...
class TrackerDeviceController(DeviceController):
    '''
    Tracker Device Controller Class
    '''
    ...
    def alert(self, pairedDeviceId, alertLevel): 
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_link_loss_value(self, pairedDeviceId, alertLevel): 
        '''
        child class should override this function to implement their body
        '''
        pass

    def get_link_loss_value(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def get_battery_level(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def get_signal_info(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass
