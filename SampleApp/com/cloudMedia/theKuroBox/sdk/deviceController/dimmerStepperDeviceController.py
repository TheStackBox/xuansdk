...
class DimmerStepperDeviceController(DeviceController):
    ...
    def set_on(self, pairedDeviceId, deviceDTO):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_off(self, pairedDeviceId, deviceDTO):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_dim(self, pairedDeviceId, deviceDTO):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_bright(self, pairedDeviceId, deviceDTO):
        '''
        child class should override this function to implement their body
        '''
        pass
