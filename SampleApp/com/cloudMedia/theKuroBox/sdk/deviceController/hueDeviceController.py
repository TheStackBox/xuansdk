...
from com.cloudMedia.theKuroBox.sdk.paramComponents.kbxColor import KBXColor
from com.cloudMedia.theKuroBox.sdk.paramComponents.kbxHSBColor import KBXHSBColor
...
class HueDeviceController(DeviceController):
    ...
    def set_on(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_off(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_color_rgb(self, pairedDeviceId, r, g, b):
        '''
        child class should override this function to implement their body
        '''
        pass

    def set_color_hsb(self, pairedDeviceId, h, s, b):
        '''
        child class should override this function to implement their body
        '''
        pass

    def get_hue_state(self, pairedDeviceId):
        '''
        child class should override this function to implement their body
        '''
        pass
