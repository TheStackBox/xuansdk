...
class WeatherService():
    ...
    def get_daytime_is(daytime, language=AppInfo.DEFAULT_API_LANGUAGE):
        ...
        daytime:String :- 0 =sunrise, 1 =sunset 
        return:Dictionary :eg- {"value": "true"}
        '''
        pass

    @staticmethod  
    def get_current_humidity_is_above(humidity, notify, language=AppInfo.DEFAULT_API_LANGUAGE):
        '''
        check the humidity is above the given value
        humidity:Number :- the humidity value to check: (percentage unit)
        notify:Option :- specify to get notification if humidity is changed.
        return:Dictionary :eg- {"value": "true"}
        '''
        pass

    @staticmethod
    def get_current_temperature_is_below(temperature, notify, language=AppInfo.DEFAULT_API_LANGUAGE):
        '''
        check the temperature is below the given value
        temperature:Number :- the temperature value to check:
        notify:Option :- specify to get notification if temperature is changed.
        return:Dictionary :eg- {"value": "false"}
        '''
        pass

    @staticmethod  
    def get_current_temperature_is_above(temperature, notify, language=AppInfo.DEFAULT_API_LANGUAGE):
        '''
        check the humidity is above the given value
        temperature:Number :- the temperature value to check:
        notify:Option :- specify to get notification if temperature is changed.
    ...
    @staticmethod
    def get_current_humidity_is_below(humidity, notify, language=AppInfo.DEFAULT_API_LANGUAGE):
        '''
        check the temperature is below the given value
    ...
    @staticmethod  
    def get_current_wind_speed_is_above(speed, notify, language=AppInfo.DEFAULT_API_LANGUAGE):
        '''
    ...
    @staticmethod
    def get_current_wind_speed_is_below(speed, notify, language=AppInfo.DEFAULT_API_LANGUAGE):
        '''
