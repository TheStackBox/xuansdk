...
define([
    ...
    var kbxTextInput = AbstractControlComponent.extend({
        template: JST['app/scripts/common/components/templates/component.control.input-text.ejs'],
        events: {
    	...
    	render: function(model) {
            ...
            this.type = (this.model.get('extra').kbxParamInputType) ? this.model.get('extra').kbxParamInputType : 'text';
