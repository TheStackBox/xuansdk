...
define([
    ...
    var NavigationView = Backbone.View.extend({
        NAV_HOME : 'nav-home',
        NAV_MENU : 'nav-menu',
		NAV_OPT : 'nav-circle-edit nav-icon-opt',  
        NAV_SKIP : 'nav-circle-edit nav-icon-skip ',      
        ...
        REFRESH : 'nav-circle-done nav-icon-refresh',

    	template: JST['app/scripts/common/templates/navigation.ejs'],
    	icon_tpl: JST['app/scripts/common/templates/nav-item.ejs'],
    	events: {
