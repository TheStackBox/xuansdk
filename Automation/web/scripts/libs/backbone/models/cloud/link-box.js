    ...
    var CloudLinkBox = KuroboxModel.extend({
        ...
        fetch: function(boxName, cid, options) {
            Kurobox.native('getLanguage', function(lang){
                ...
                //generate url
                this.dev_opt.param.url = Kurobox.cloudhost+'/c/client/linkBox;jsessionid='+this.session+'?'+this.objToParam(paramObj);
    ...
    var CloudUnlinkBox = KuroboxModel.extend({
        ...
        fetch: function(options) {
            Kurobox.native('getLanguage', function(lang){
                ...
                //generate url
                this.dev_opt.param.url = Kurobox.cloudhost+'/c/client/unlinkBox;jsessionid='+this.session+'?'+this.objToParam(paramObj);
