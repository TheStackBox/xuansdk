...
define([
    ...
    // default param
    var defaultParam = {
        module: 'device_manager.dimmer_stepper_controller',
    }
	...
	var HueControlModel = KuroboxModel.extend({
		...
		dim: function(options) {
			this._writeAndSave('set_dim', undefined, options);
		},

        brighten: function(options) {
            this._writeAndSave('set_bright', undefined, options);
        },
