...
class SwitchControllerModule(Module):
    ...
    def get_capabilities(self, request):
        try:
            ...
            returnStr = SwitchControllerService.get_capabilities(pairedDeviceId)
    ...
    def get_status(self, request):
        try:
            pairedDeviceId = request.get_arg("pairedDeviceId")
            returnStr = SwitchControllerService.get_status(pairedDeviceId)
            self.send_response(returnStr, request.requestId)
        except SystemException as se:
            self.send_response(Sys.get_system_exception_return("en", se.value["returnValue"], se.value["returnMessage"]), request.requestId, se.value["returnValue"])
        except Exception as e:
    ...
    def get_meter_usage(self, request):
        try:
            pairedDeviceId = request.get_arg("pairedDeviceId")
            returnStr = SwitchControllerService.get_meter_usage(pairedDeviceId)
            self.send_response(returnStr, request.requestId)
        except SystemException as se:
            self.send_response(Sys.get_system_exception_return("en", se.value["returnValue"], se.value["returnMessage"]), request.requestId, se.value["returnValue"])
        except Exception as e:
    ...
    def set_on(self, request):
        try:
            pairedDeviceId = request.get_arg("pairedDeviceId")
            returnStr = SwitchControllerService.set_on(pairedDeviceId)
            self.send_response(returnStr, request.requestId)
        except SystemException as se:
            self.send_response(Sys.get_system_exception_return("en", se.value["returnValue"], se.value["returnMessage"]), request.requestId, se.value["returnValue"])
        except Exception as e:
    ...
    def set_off(self, request):
        try:
            pairedDeviceId = request.get_arg("pairedDeviceId")
            returnStr = SwitchControllerService.set_off(pairedDeviceId)
            self.send_response(returnStr, request.requestId)
        except SystemException as se:
            self.send_response(Sys.get_system_exception_return("en", se.value["returnValue"], se.value["returnMessage"]), request.requestId, se.value["returnValue"])
        except Exception as e:
